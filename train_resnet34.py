...
os.environ["CUDA_VISIBLE_DEVICES"] = cfg2.GPU_ID
...
# 是否断点训练
if cfg2.CHECKPOINT == True:
    last_path = './checkpoint/' + cfg2.DATASET_NAME + '_' + cfg2.Loss +  '/' + 'last.pth'
...
for epoch in range(cur_epochs, num_epochs):
    ...
    # 权重保存路径
    best_path = './checkpoint/' + cfg2.DATASET_NAME + '_resnet34' + cfg2.Loss
    mkdir(best_path)
    last_path = './checkpoint/' + cfg2.DATASET_NAME + '_resnet34' + cfg2.Loss
    mkdir(last_path)
