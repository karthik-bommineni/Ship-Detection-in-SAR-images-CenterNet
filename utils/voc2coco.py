            ...
            with open(json_file, 'r', encoding='UTF-8') as fp:
                ...
                for p in fp:
                    ...
                    if flag == 1:
                        ...
                        if key == 'cx' or key == 'rotated_bbox_cx':
                            self.ob.append(p.split('>')[1].split('<')[0])
                        if key == 'cy' or key == 'rotated_bbox_cy':
                            self.ob.append(p.split('>')[1].split('<')[0])
                        if key == 'w' or key == 'rotated_bbox_w':
                            self.ob.append(p.split('>')[1].split('<')[0])
                        if key == 'h' or key == 'rotated_bbox_h':
                            self.ob.append(p.split('>')[1].split('<')[0])
                        if key == 'angle' or key == 'rotated_bbox_theta':
                            self.ob.append(p.split('>')[1].split('<')[0])
                            flag = 1
