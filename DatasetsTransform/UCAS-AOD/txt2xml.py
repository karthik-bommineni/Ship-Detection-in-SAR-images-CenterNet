...
def load_annoataion(txt_path):
    ...
    for line in lines:
        ...
        boxes.append(line)
        labels.append('car')                               # plane OR car

    return np.array(boxes), np.array(labels)


if __name__ == "__main__":
    txt_path = '/home/wulele/RotateSparseRCNN/projects/SparseRCNN/datasets/UCAS_AOD/CAR'
    xml_path = '/home/wulele/RotateSparseRCNN/projects/SparseRCNN/datasets/UCAS_AOD/Annotations'
    scr_img_path = '/home/wulele/RotateSparseRCNN/projects/SparseRCNN/datasets/UCAS_AOD/CAR'
    img_path = '/home/wulele/RotateSparseRCNN/projects/SparseRCNN/datasets/UCAS_AOD/JPEGImages'
    ...
    for count, t in enumerate(txts):
        ...
        shutil.copy(os.path.join(scr_img_path, img_name), os.path.join(img_path, 'car' + img_name))
        h, w, d = img.shape
        WriterXMLFiles('car' + xml_name, xml_path, boxes, labels, w, h, d)
