'''
此脚本用于将 HRSC2016数据集 --> 八点表示法 --> opencv表示法里面的五点表示法: [cx,cy,w,h, [-90,0)]
---> [cx,cy , long(h) ,short(w), theta [0,180) ]
...
if __name__ == '__main__':
    ...
    src_xml_path = '/home/wujian/data/dataset/HRSC2016/Test/Annotations/'
    xml_path = '/home/wujian/data/dataset/HRSC2016/Test/voc_xmls'
