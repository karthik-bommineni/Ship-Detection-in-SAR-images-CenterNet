...
class PascalVOC2coco(object):
            ...
            with open(json_file, 'r', encoding='UTF-8') as fp:
                ...
                for p in fp:
                    ...
                    if 'filename' in p:
                        ...
                        f_name = 0
                        self.path = os.path.join(path, 'SegmentationObject',
                                                 self.filen_ame.split('.')[0] + '.png')  # .bmp !!!!
                    if 'width' in p:
    ...
    def image(self):
        ...
        image['id'] = self.num + 1
        image['file_name'] = self.filen_ame.split('.')[0] + '.bmp'  ##############################
        return image
...
'''
# 转换好的xml文件路径
xml_file = glob.glob('/home/wujian/data/dataset/HRSC2016/Test/new_xmls/*.xml')
PascalVOC2coco(xml_file, '/home/wujian/data/dataset/HRSC2016/Test/val.json')
