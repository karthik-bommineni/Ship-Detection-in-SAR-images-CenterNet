...
os.environ["CUDA_VISIBLE_DEVICES"] = cfg1.GPU_ID
...
# 是否断点训练
if cfg1.CHECKPOINT == True:
    last_path = './checkpoint/' + cfg1.DATASET_NAME + '_' + cfg1.Loss +  '/' + 'last.pth'
